...
/// Native (mobile/desktop) [StorageService] implementation backed by
/// sqflite. Schema-equivalent to the previous DatabaseService, kept in
/// its own file so the web bundle never has to touch sqflite imports.
class SqliteStorageService implements StorageService {
  ...
  Future<void> _onUpgrade(Database db, int oldVersion, int newVersion) async {
    debugPrint(
      'SqliteStorageService: upgrading from version $oldVersion to $newVersion',
    );
